(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_8f3d4d._.js", {
...
const ShowProducts = ()=>{
    _s();
    const [productIndex, setProductIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [imageIndex, setImageIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // For cycling through images of the current product
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"])('description'); // Manage active tab
    const product = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"][productIndex]; // Get the product based on the current index
    const [newStars, setNewStars] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // for star rating
    const [newName, setNewName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // for user name input
    const [newReview, setNewReview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // Input for new review
    const [reviews, setReviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])([
        {
            id: 1,
            name: "John Doe",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"])({
    ...
    const handleNextProduct = ()=>{
        setProductIndex((prevIndex)=>(prevIndex + 1) % __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].length);
        setImageIndex(0); // Reset image index when changing product
    };
    const handlePrevProduct = ()=>{
        setProductIndex((prevIndex)=>(prevIndex - 1 + __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].length) % __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"].length);
        setImageIndex(0); // Reset image index when changing product
    };
...
_s(ShowProducts, "SyUQv1dRFYSpXBmXM8UIo/5zzpI=");
_c = ShowProducts;
...
//# sourceMappingURL=_8f3d4d._.js.map