...
const ShopPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const productId = searchParams.get('id');
        if (productId) {
            const product = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$Constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].find((prod)=>prod.id === parseInt(productId));
            if (product) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__da46d8._.js.map